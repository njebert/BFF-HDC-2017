...
namespace BFFLogic.Models
{
    public partial class WWIContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=localhost;Database=WWI;Trusted_Connection=True");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ColdRoomTemperatures>(entity =>
            {
                ...
                entity.Property(e => e.Temperature).HasColumnType("decimal");
            });
            ...
            modelBuilder.Entity<PurchaseOrderLines>(entity =>
            {
                ...
                entity.Property(e => e.ExpectedUnitPricePerOuter).HasColumnType("decimal");
            ...
            modelBuilder.Entity<StockItemHoldings>(entity =>
            {
                ...
                entity.Property(e => e.LastCostPrice).HasColumnType("decimal");
            ...
            modelBuilder.Entity<StockItems>(entity =>
            {
                ...
                entity.Property(e => e.RecommendedRetailPrice).HasColumnType("decimal");
                ...
                entity.Property(e => e.TypicalWeightPerUnit).HasColumnType("decimal");
